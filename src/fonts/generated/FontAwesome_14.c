 ...
 * Size: 14 px
 * Bpp: 4
 * Opts: --size 14 --bpp 4 --format lvgl --font /Users/gj0987888/Documents/GitHub/G-Watch-2.0/src/fonts/FontAwesome5.woff --range 0xf0e7, 0xf240, 0xf241, 0xf242, 0xf243, 0xf244, 0xf54b, 0xf294, 0xf287, 0xf1eb, 0xf0e0, 0xf0f3, 0xf192, 0xf392, 0xf075, 0xf7cd, 0xf0e0, 0xf255, 0xf167 --output /Users/gj0987888/Documents/GitHub/G-Watch-2.0/src/fonts/generated/FontAwesome_14.c --no-compress
 ******************************************************************************/
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0xc5, 0x0, 0x0, 0x3, 0xff, 0x2f, 0xff, 0xff,
    0xff, 0xff, 0xa0, 0x0, 0x7, 0xff, 0x2f, 0xff,
    0xff, 0xff, 0xff, 0xf4, 0x0, 0x2, 0xef, 0x2f,
    0xff, 0xff, 0xff, 0xff, 0xf6, 0x0, 0x0, 0x1,
    0x2, 0x5c, 0xff, 0xff, 0xff, 0xd1, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x4a, 0xdd, 0xb6, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x1, 0x45, 0x41, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x8f, 0xff, 0xff, 0xb2,
    0x0, 0x0, 0x29, 0x65, 0xbf, 0xff, 0xff, 0xff,
    0xfc, 0x0, 0x0, 0xdf, 0xa8, 0xff, 0xff, 0xff,
    0xff, 0xfe, 0x0, 0x0, 0xef, 0xa8, 0xff, 0xff,
    0xff, 0xff, 0xf8, 0x0, 0x0, 0x5d, 0x87, 0xff,
    ...
    0x1c, 0xff, 0xff, 0xff, 0xff, 0xc1, 0x0, 0x1e,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xd1, 0x9, 0xff,
    0xdf, 0xdf, 0xee, 0xfd, 0xff, 0x80, 0xef, 0xd3,
    0xd0, 0x43, 0x46, 0x4f, 0xfe, 0xf, 0xff, 0x4c,
    0x3, 0x34, 0xb2, 0xef, 0xf0, 0xdf, 0xf3, 0xb0,
    0xbb, 0x4a, 0x2e, 0xfd, 0x7, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0x70, 0xc, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xc0, 0x0, 0xbf, 0xff, 0xff, 0xff,
    0xff, 0xa0, 0x0, 0x3f, 0xfc, 0xad, 0xff, 0xd9,
    0x30, 0x0, 0xa, 0xb5, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0
};
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 175, .adv_w = 140, .box_w = 10, .box_h = 15, .ofs_x = -1, .ofs_y = -2},
    {.bitmap_index = 250, .adv_w = 196, .box_w = 13, .box_h = 15, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 348, .adv_w = 252, .box_w = 16, .box_h = 12, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 444, .adv_w = 224, .box_w = 14, .box_h = 15, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 549, .adv_w = 280, .box_w = 18, .box_h = 13, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 666, .adv_w = 280, .box_w = 18, .box_h = 10, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 756, .adv_w = 280, .box_w = 18, .box_h = 10, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 846, .adv_w = 280, .box_w = 18, .box_h = 10, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 936, .adv_w = 280, .box_w = 18, .box_h = 10, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 1026, .adv_w = 280, .box_w = 18, .box_h = 10, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 1116, .adv_w = 224, .box_w = 14, .box_h = 13, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 1207, .adv_w = 280, .box_w = 18, .box_h = 12, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 1315, .adv_w = 140, .box_w = 9, .box_h = 15, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 1383, .adv_w = 196, .box_w = 13, .box_h = 15, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 1481, .adv_w = 280, .box_w = 18, .box_h = 15, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 1616, .adv_w = 224, .box_w = 15, .box_h = 13, .ofs_x = -1, .ofs_y = -1}
};
