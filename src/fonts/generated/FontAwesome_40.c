 ...
 * Size: 40 px
 * Bpp: 4
 * Opts: --size 40 --bpp 4 --format lvgl --output C:\Users\garre\OneDrive\Documents\GitHub\G-Watch-2.0\src\fonts\generated/FontAwesome_40.c --no-compress --font FontAwesome6Pro.woff --range 0xf04b, 0xf04c, 0xf0f3, 0xf075, 0xf7cd, 0xf0e0, 0xf2e1 --font FontAwesome5.woff --range 0xf392, 0xf167
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 480, .box_w = 30, .box_h = 38, .ofs_x = 0, .ofs_y = -4},
    {.bitmap_index = 570, .adv_w = 400, .box_w = 25, .box_h = 31, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 958, .adv_w = 640, .box_w = 41, .box_h = 36, .ofs_x = -1, .ofs_y = -3},
    {.bitmap_index = 1696, .adv_w = 640, .box_w = 40, .box_h = 30, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2296, .adv_w = 560, .box_w = 37, .box_h = 40, .ofs_x = -1, .ofs_y = -5},
    {.bitmap_index = 3036, .adv_w = 720, .box_w = 43, .box_h = 31, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 3703, .adv_w = 480, .box_w = 30, .box_h = 41, .ofs_x = 0, .ofs_y = -5},
    {.bitmap_index = 4318, .adv_w = 560, .box_w = 35, .box_h = 40, .ofs_x = 0, .ofs_y = -5},
    {.bitmap_index = 5018, .adv_w = 640, .box_w = 41, .box_h = 36, .ofs_x = -1, .ofs_y = -3}
};
...
static const uint16_t unicode_list_0[] = {
    0x0, 0x1, 0x2a, 0x95, 0xa8, 0x11c, 0x296, 0x347,
    0x782
};
