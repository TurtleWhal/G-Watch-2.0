...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 2296, .adv_w = 720, .box_w = 43, .box_h = 31, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 2963, .adv_w = 560, .box_w = 33, .box_h = 40, .ofs_x = 2, .ofs_y = -5},
    {.bitmap_index = 3623, .adv_w = 560, .box_w = 35, .box_h = 40, .ofs_x = 0, .ofs_y = -5},
    {.bitmap_index = 4323, .adv_w = 640, .box_w = 41, .box_h = 36, .ofs_x = -1, .ofs_y = -3}
};
